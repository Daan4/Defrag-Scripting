...
*/
void HUD_Init( void ) {
    iodfe_hud_snap_draw = Cvar_Get ("iodfe_hud_snap_draw", "1", CVAR_ARCHIVE);
    iodfe_hud_snap_rgba1 = Cvar_Get ("iodfe_hud_snap_rgba1", ".4 0 0 .5", CVAR_ARCHIVE);
    iodfe_hud_snap_rgba2 = Cvar_Get ("iodfe_hud_snap_rgba2", "0 .4 .4 .5", CVAR_ARCHIVE);
    ...
    iodfe_hud_pitch = Cvar_Get ("iodfe_hud_pitch", "70 -15", CVAR_ARCHIVE);
